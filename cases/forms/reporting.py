...
class BestTimeForm(StepForm):
    ...
    def __init__(self, staff, *args, **kwargs):
        ...
        if staff:
            ...
            self.fields["best_time"].label = "When is the best time to contact the reporter?"
            self.fields["best_method"].label = "What is the best method for contacting the reporter?"
